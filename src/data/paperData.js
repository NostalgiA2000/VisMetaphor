...
export let paper = [
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction", "Entity", ["Spatiotemporal"],"Desktop"],
        //application应用场景
        ["HCI","SciExpriment"],
        //constructMethod构建隐喻的方法 
        ["Interaction Design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Inspiration",["Spatiotemporal"],"Pointer"],
        //application 应用场景
        ["HCI","VR/AR"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction", "Non-Entity", ["Spatiotemporal"],"Cube"],
        //application应用场景
        ["Geography"],
        //constructMethod构建隐喻的方法 
        ["Distance","Topology", "Attribute", "Hybrid"],
        //task任务/功能
        ["Expolre"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form", "Entity", ["Relational"],"Bacterium"],
        //application应用场景
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form", "Entity", ["Relational"],"Lightening"],
        //application应用场景
        ["BioloMedical"],
        //constructMethod构建隐喻的方法 
        ["Attribute","Topology","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction", "Action", ["Spatiotemporal"],"sculpture"],
        //application 应用场景
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured"],"Wheel"],
        //application 应用场景
        ["MarketingAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute","Topology","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Relational"],"Flow"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured","Spatiotemporal"],"Flow"],
        //application 应用场景
        ["Academic"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal","Structured"],"Band"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Action",["Unstructured","Spatiotemporal"],"Sedimentation"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Physical"],"Kite"],
        //application 应用场景
        ["Physical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Text"],"StickyNote"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid\Interaction Design\Artistic design
        ["Artistic design"],
        //task 任务/功能
        ["Enjoy"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured"],"MusicScore"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Relational"],"Shutter"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Physical","Relational"],"Bubble"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal"],"Line"],
        //application 应用场景
        ["BiologyMedical","ComputerScience"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
        //task 任务/功能
        ["Explore"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured"],"Lines"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Clock"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Distance","Hybrid"],
        //task 任务/功能
        ["Explore"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Media","Relational","Spatiotemporal"],"Flow"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Action",["Structured"],"DirectManipulation"],
        //application 应用场景
        ["Academic","HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",[,"Structured","Relational"],"Map"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Insperation",["Structured"],"Glyps"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute","Topology","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Spatiotemporal"],"Flower"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured"],"Flow"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Relational"],"Tree"],
        //application 应用场景
        ["HCI","BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"DashBoard"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Relational","Spatiotemporal"],"Flow"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Non-entity",["Structured"],"Lens"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Spatiotemporal"],"Filtering"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"Film-Strip"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Unstructured"],"ParallelCoordinate"],
        //application 应用场景
        ["Academic"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured","Spatiotemporal"],"HeatMap"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Unstructured","Spatiotemporal"],"Flow"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Relational","Volume"],"fiber stippling"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Structured"],"Seesaw"],
        //application 应用场景
        ["DigitHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured"],"TopologyMap"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Unstructured"],"Cartoon"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured"],"Terrian Map"],
        //application 应用场景
        ["Academic"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Distance","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Unstructured"],"Flow"],
        //application 应用场景
        ["Academic","DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
        //task 任务/功能
        ["Present"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Unstructured"],"Triangle"],
        //application 应用场景
        ["MarketingAnalysis","SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance"],
        //task 任务/功能
        ["Enjoy"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured"],"ParallelCoordinate"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured"],"Landscape"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Unstructured"],"Lens"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Field"],"Surgical tools"],
        //application 应用场景
        ["HCI","BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Structured"],"SpaceFilling"],
        //application 应用场景
        ["DataAnalysis","BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
        //task 任务/功能
        ["Browse"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Unstructured"],"SolarSystem"],
        //application 应用场景
        ["HCI","ComputerScience"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Action",["Field"],"Exploded view"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured","Spatiotemporal"],"Map","Timeline"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured"],"ParallelSet"],
        //application 应用场景
        ["DataAnalysis","MarketingAnalysis","DigitHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
        //task 任务/功能
        ["Present"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Piano"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Artistic design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Spatiotemporal"],"Camera"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Non-entity",["Structured"],"TabbedPane"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Inspiration",["Structured"],"X-Ray"],
        //application 应用场景
        ["SocialMedia","HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["form","Non-entity",["Relational","Structured"],"WrappedLine"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Relational"],"Telescope"],
        //application 应用场景
        ["HCI","DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"SedimentaryRock"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Field"],"Tweezer"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Field"],"Book","FoldingFan"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured","Spatiotemporal","Structured"],"City"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Structured"],"Landscape"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute","Topology","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Structured"],"SolarSystem"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute","Topology","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Structured"],"City"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute","Topology","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Relational"],"Flow"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Text","Time"],"Flow"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal"],"Flow"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","R",["Relational","Structured"],"City"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"Cloud"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Attribute","Hybrid"],
        //task 任务/功能
        ["Enjoy","Summarize"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal","Unstructured"],"Flow"],
        //application 应用场景
        ["DigitHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"Pebble"],
        //application 应用场景
        ["DataAnalysis","ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
        //task 任务/功能
        ["Enjoy"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"River","Cloud","Tree"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Attribute","Topology","Hybrid"],
        //task 任务/功能
        ["Enjoy","Summarize"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Inspiration",["Spatiotemporal"],"ScreenShot"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal","Unstructured"],"MlultiRing"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance","Attribute","Hybrid"],
        //task 任务/功能
        ["Enjoy","Summarze"],
        "https://dl.acm.org/doi/10.5555/3290776.3290782",//url
        //publication
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Spatiotemporal"],"Clock"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Relational"],"NodeLink"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Action",["Structured","Spatiotemporal"],"Piling"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Distance"],
        //task 任务/功能
        ["Present"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Field"],"Feather"],
        //application 应用场景
        ["DataAnalysis","Attritube","Hybrid"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Distance"],
        //task 任务/功能
        ["Discover","Explore"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured","Spatiotemporal"],"Temperature"],
        //application 应用场景
        ["Geography"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Tangram"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured","Spatiotemporal"],"Bar"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Unstructured"],"Map"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured","Spatiotemporal"],"Clock","Glyph"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Inspiration",["Unstructured"],"Glyph"],
        //application 应用场景
        ["DigitalHumanities","DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
        //task 任务/功能
        ["Enjoy"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Relational"],"Clock"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"RubbleBand"],
        //application 应用场景
        ["Geography"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Artistic design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Inspiration",["Spatiotemporal"],"WeatherVane"],
        //application 应用场景
        ["Geography","DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
        //task 任务/功能
        ["Enjoy"],
    ...
    new Content(
        ...
        "https://ieeexplore.ieee.org/document/9418624",//url
        //publication
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"Tree","Flower"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        "HandleBar(2020) NO METAPHOR",//name
        //title
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Field"],"HandleBar"],
        //application 应用场景
        ["BiologyMedical","HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Inspiration",["MetaData"],"Color"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured","Spatiotemporal"],"Clock"],
        //application 应用场景
        ["ElectronicEngineering","DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
        //task 任务/功能
        ["Summarize"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal"],"Wedge"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Artistic design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured","Spatiotemporal"],"Radar"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Non-entity",["Structured"],"Retractor"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Structured","Spatiotemporal"],"Trapezoid"],
        //application 应用场景
        ["DigitalHumanities","Geography"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
        //task 任务/功能
        ["Enjoy"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["DataSet"],"RangeLikelihoodTree"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Non-entity",["Field"],"Lens"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        "NodeLink(2013) NO METAPHOR",//name
        //title
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Non-entity",["Text"],"Lens"],
        //application 应用场景
        ["MarketingAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"MetroMap"],
        //application 应用场景
        ["DataAnalysis","Academic"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Distance","Hybrid"],
        //task 任务/功能
        ["Sumarize","Enjoy"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Relational"],"Ballon"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Unstructured"],"Painting"],
        //application 应用场景
        ["HCI","DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Cartoon"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Radar"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"Zipper"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Relational","Structured","Spatiotemporal"],"CaricatureBook"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        [""],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Weather"],
        //application 应用场景
        ["BiologyMedical"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Action",["Spatiotemporal"],"Grasp"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Relational"],"Canvas"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured"],"Bookshelf"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Spatiotemporal"],"ClockMap"],
        //application 应用场景
        ["Geograhpy","HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Action",["Spatiotemporal"],"Sculptor"],
        //application 应用场景
        ["DataAnalysis","HCI"],
        //constructMethod 构建隐喻的方法:Attribute Topology Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Vessels"],
        //application 应用场景
        ["Geography"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal"],"Bubble"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Tolopogy","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"Ecosystem"],
        //application 应用场景
        ["DigitalHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured"],"Dust&Manget"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Distance"],
    ...
    new Content(
        ...
        ["Form","Entity",["Relational"],"MetroMap"],
        //application 应用场景
        ["MarketingAnalysis","DigitHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Topology"],
        //task 任务/功能
        ["Enjoy","Summarize"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Action",["Structured"],"Lagrangian"],
        //application 应用场景
        ["SciExperiment"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Distance"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured","Relational"],"MetroMap"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Topology","Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Action",["Relational"],"Sedimentation"],
        //applicmation 应用场景
        ["BiologyMedical","ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute"],
        //task 任务/功能
        ["Summarize"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Field"],"Desktop"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal"],"TimeSpiderTrees"],
        //application 应用场景
        ["DataAnaylysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["MetaData"],"Matrix"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaciton","Entity",["Spatiotemporal"],"Lens"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Unstructured"],"Clock"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Unstructured"],"Radar"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Spatiotemporal","Unstructured"],"Maps"],
        //application 应用场景
        ["DigitHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Topology"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational","Spatiotemporal"],"Map"],
        //application 应用场景
        ["SocialMedia"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Distance","Topology","Attribute","Hybrid"],
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Non-entity",["Spatiotemporal","Relational"],"Flow"],
        //application 应用场景
    ...
    new Content(
        ...
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Enttity",["Spatiotemporal"],"BarrierTape"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Interaction design"],
    ...
    new Content(
        "2022-InstructionalVeideosForPhysics-Glyph-174",//id
        "Instructional Glyph(2022)",//name
        //title
        ...
        //picturePath
        "../picture100/2022-InstructionalVideosForPhysicalTraining-Glyph.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Inspiration",["Unstructured"],"Glyph"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Artistic design"],
        //task 任务/功能
        ["Present"],
        "https://dl.acm.org/doi/10.1145/3491102.3517735",//url
        //publication
        "Proceedings of the CHI '22: Proceedings of the 2022 CHI Conference on Human Factors in Computing Systems.",
        //innerContent
        {
            Abstract:"",
            Func:[""],
    ...
    new Content(
        "2022-OperationOnTheDevice-Hourglass-175",//id
        "Hourglass(2022)",//name
        //title
        "SABLIER : a Tangible Interactor to Navigate through Space andTime",
        "2022",//year
        //authors
        "Pierre Mahieux, Romain Biannic, Sébastien Kubicki, Ronan Querrec",
        //picturePath
        "../picture100/2022-OperationOnTheDevice-Hourglass.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["Unstructured"],"Hourglass"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Artistic design"],
        //task 任务/功能
        ["Present"],
        "https://dl.acm.org/doi/10.1145/3491102.3517567",//url
        //publication
        "Proceedings of the CHI '22: Proceedings of the 2022 CHI Conference on Human Factors in Computing Systems.",
        //innerContent
        {
    ...
    new Content(
        ...
        //picturePath
        "../picture100/2022-Picture-RollFilm.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Structured"],"RollFilm"],
        //application 应用场景
        ["HCI"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Artistic design"],
        //task 任务/功能
        ["Present"],
        "https://dl.acm.org/doi/10.1145/3569887",//url
        //publication
        "Proceedings of the CHI '22: Proceedings of the 2022 CHI Conference on Human Factors in Computing Systems.",
        //innerContent
        {
    ...
    new Content(
        ...
        //picturePath
        "../picture100/2022-NightSky-movie.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"NightSky"],
        //application 应用场景
        ["DigitHumanities"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute"],
        //task 任务/功能
        ["Present"],
        "https://dl.acm.org/doi/10.1145/3491101.3516393",//url
        //publication
        "Proceedings of the CHI '22: Proceedings of the 2022 CHI Conference on Human Factors in Computing Systems.",
        //innerContent
        {
    ...
    new Content(
        "2022-Map-Graph-178",//id
        "Map(2022)",//name
        //title
        "Metaphoric maps for dynamic vertex-weighted graphs",
        "2022",//year
        //authors
        " T. Mchedlidze, RC.Schnorr",
        //picturePath
        "../picture100/2022-Map-Graph.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"Map"],
        //application 应用场景
        ["DataAnalysis"],
        ...
        //task 任务/功能
        ["Present"],
        "https://diglib.eg.org/items/3eafb9ff-3713-41e7-b8ec-45468dee7b2c",//url
        //publication
        "EuroVisShort2022",
        //innerContent
        {
    ...
    new Content(
        "2023-/-ShadowBox-179",//id
        "ShadowBox(2023)",//name
        //title
        "Evaluating View Management for Situated Visualization in Web-based Handheld AR",
        "2023",//year
        //authors
        "A. Batch, S. Shin, J. Liu, P. W. S. Butcher, P. D. Ritsos, N. Elmqvist",
        //picturePath
        "../picture100/2023-shadowBox.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Non-Entity",["/"],"ShadowBox"],
        //application 应用场景
        ["VR/AR"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        [""],
        //task 任务/功能
        ["Present"],
        "https://onlinelibrary.wiley.com/doi/10.1111/cgf.14835",//url
        //publication
    ...
    new Content(
        "2024-/-Thread-MOOC-180",//id
        "Thread(2024)",//name
        //title
        "ConceptThread: Visualizing Threaded Concepts in MOOC Videos",
        "2023",//year
        //authors
        "Zhiguang Zhou, Li Ye, Lihong Cai, Lei Wang, Yigang Wang, Yongheng Wang",
        //picturePath
        "../picture100/2024-thread-text&veido.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Unstructured"],"thread"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute,Topology,Hybrid"],
        //task 任务/功能
        ["Present"],
        "https://ieeexplore.ieee.org/document/10418508",//url
        //publication
    ...
    new Content(
        "2024-/-Sedimentation-VisualElements-181",//id
        "Sedimentation(2024)",//name
        //title
        ...
        "Zhiguang Zhou, Li Ye, Lihong Cai, Lei Wang, Yigang Wang, Yongheng Wang",
        //picturePath
        "../picture100/2024-sedimentation-VisualElements.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Action",["Structured"],"thread"],
        //application 应用场景
        ["DataAnalysis"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute,Topology,Hybrid"],
        //task 任务/功能
        ["Present"],
        "https://dl.acm.org/doi/full/10.1145/3657642",//url
        //publication
        "IEEE Transactions on Visualization and Computer Graphics ( Early Access )",
        //innerContent
        {
    ...
    new Content(
        ...
        //task 任务/功能
        ["Present"],
        "https://ieeexplore.ieee.org/document/10443294",//url
        //publication
        "IEEE Transactions on Visualization and Computer Graphics ( Early Access )",
        //innerContent
        {
    ...
    new Content(
        "2023-/-2.5DTreeMap-182",//id
        "2.5DTreeMap(2024)",//name
        //title
        "Visual variables and configuration of software maps",
        "2023",//year
        //authors
        "Daniel Limberger, Willy Scheibel, Jürgen Döllner ",
        //picturePath
        "../picture100/2023-Treemap.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Form","Entity",["Relational"],"TreeMap"],
        //application 应用场景
        ["ElectronicEngineering"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute,Topology,Hybrid"],
        //task 任务/功能
        ["Present"],
        "https://link.springer.com/article/10.1007/s12650-022-00868-1",//url
        //publication
    ...
    new Content(
        ...
        "Door(2024)",//name
        //title
        "Visual Metaphors for Notification into Virtual Environments",
        "2023",//year
        //authors
        "Fabian Pointecker, David Oberögger, Christoph Anthes",
        //picturePath
        "../picture100/2023-Doors.png",
        //group:Form / Interaction, Z / R / F / D / K , 1 ~ 13 , shape
        ["Interaction","Entity",["/"],"Door"],
        //application 应用场景
        ["VR/AR"],
        //constructMethod 构建隐喻的方法:Attribute Tolopogy Distance Hybrid
        ["Attribute,Topology,Hybrid"],
        //task 任务/功能
        ["Present"],
        "https://ieeexplore.ieee.org/document/10322130",//url
        //publication
